...
const WIP9_ADDRESS = '0x1516000000000000000000000000000000000000'; // Wrapped IP
...
// --- RAW INPUT FOR SWAP ---
const rawInputForSwap = '';
const originalAmountSlot = '000000000000000000000000000000000000000000000000016345785d8a0000'; // 0.1 IP slot for replacement

async function testFullPurchaseFlow() {
    console.log('🚀 Starting FINAL test purchase flow...');
    ...
    try {
        ...
        const wip9Contract = new ethers.Contract(WIP9_ADDRESS, ERC20_ABI, wallet);
        ...
        if (currentAllowance < amountToSend) {
            ...
            const approveTx = await wip9Contract.approve(AGGREGATOR_ADDRESS, ethers.MaxUint256, {
        ...
        // Correctly replace the amount in the raw input data
        ...
        // Use populateTransaction to let ethers build the tx object robustly
        ...
        console.log(`   - Value: ${ethers.formatEther(txRequest.value)} IP`);
